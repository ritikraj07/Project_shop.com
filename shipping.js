var shipping_data = JSON.parse(localStorage.getItem('cart'))||[]
    display(shipping_data)

    function display(DATA){
        var total_price = 0
        document.querySelector('#pro_appender').innerHTML='';
        DATA.map(function(element, index){
            ...
            div2.append(name, price, p1, item, color, size, div3, s4l,removebtn )
            product_.append(div1, div2)
        ...
        // var tt = total_price+ +13.43
        var total = +localStorage.getItem("totalPrice")+ +13.43
        
        console.log(total)
        document.getElementById('total1').innerText= total.toFixed(2)
        document.getElementById('total2').innerText= (+localStorage.getItem("totalPrice")).toFixed(2)
    ...
    function remove_from_cart(index){
      shipping_data.splice(index, 1)
      localStorage.setItem('cart',JSON.stringify( shipping_data))
      display( shipping_data)
    }    
